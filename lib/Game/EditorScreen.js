		...
		class EditorScreen extends Framework.Screen {
			constructor(options) {
				...
				var menu = new Framework.Menu({
					vPosition: 'absolute',
					hPosition: 'absolute',
					x: window.innerWidth-(buttonwidth+5)*6-5,
					y: 0,
					width: (buttonwidth+5)*6+5,
					height: 40,
					colour: '#000'
				});
				let relativeX = 5;
				var shademenu = new Framework.Button({
					...
					colour: '#eee',
					hovercolour: '#ccc',
					text: new Framework.Text({font:'14pt Calibri', label:'Shade', halign:'right'}),
				...
				var longgrassmenu = new Framework.Button({
					...
					colour: '#eee',
					hovercolour: '#ccc',
					text: new Framework.Text({font:'14pt Calibri', label:'L. Grass', halign:'right'}),
				...
				var watermenu = new Framework.Button({
					...
					colour: '#eee',
					hovercolour: '#ccc',
					text: new Framework.Text({font:'14pt Calibri', label:'Water', halign:'right'}),
				...
				var grassmenu = new Framework.Button({
					...
					colour: '#eee',
					hovercolour: '#ccc',
					text: new Framework.Text({font:'14pt Calibri', label:'Grass', halign:'right'}),
				...
				var groundmenu = new Framework.Button({
					...
					colour: '#eee',
					hovercolour: '#ccc',
					text: new Framework.Text({font:'14pt Calibri', label:'Dirt', halign:'right'}),
				...
				var exitmenu = new Framework.Button({
					...
					colour: '#eee',
					hovercolour: '#ccc',
					text: new Framework.Text({font: '14pt Calibri', label:'Exit' , halign:'right'})
				});
