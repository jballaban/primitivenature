...
JS.extend(JS.Method.prototype, {
  ...
  compile: function(environment) {
    ...
    var compiled = function() {
      var N = keywords.length, j = N, previous = {}, keyword, existing, kwd, args = new Array(arguments.length);
      ...
      while (j--) {
        ...
        kwd = keyword.filter(method, environment, this, args);
        if (kwd) kwd.__kwd__ = true;
        this[keyword.name] = kwd;
      }
      var returnValue = callable.apply(this, args),
          j = N;
