	...
	insert: function (tileX, tileY, type) {
		...
		for (var i=0;i<9;i++) {
			...
			*/
			...
			if (9-i==1)
				adjacent[i][type].push(1,2,4);
			else if (9-i == 2)
				adjacent[i][type].push(1,2,3,4,6);
			else if (9-i == 3)
				adjacent[i][type].push(2,3,6);
			else if (9-i == 4)
				adjacent[i][type].push(1,4,7,2,8);
			else if (9-i==6)
				adjacent[i][type].push(2,3,6,8,9);
			else if (9-i==7)
				adjacent[i][type].push(4,7,8);
			else if (9-i== 8)
				adjacent[i][type].push(4,6,7,8,9);
			else if (9-i==9)
				adjacent[i][type].push(6,8,9);
...
Game.Tiles.Tile = new JS.Class(Framework.Element, {
	...
	getSprite: function(ground, grass) {
		var selection = [
			// water
			{ ground: '', grass: '', water: '12346789', sourceX: 15+(Math.floor(Math.random()*4)), sourceY: 15 },
			// waterground
			{ ground: '1234689', grass: '', water: '478', sourceX: 16+(Math.floor(Math.random()*2)), sourceY: 10 },
			// ground
