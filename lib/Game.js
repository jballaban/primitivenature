...
JS.packages(function() { with(this) {
    ...
    file('lib/EditorScreen.js').provides('Game.EditorScreen').requires('Framework.Screen', 'Game.World', 'Game.Tiles', 'Framework.Menu');
    file('lib/World.js').provides('Game.World').requires('Framework.Element', 'Game.Tiles');
